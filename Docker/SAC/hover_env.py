...
class HoverEnv:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False, device="cuda"):
        ...
        self.drone = self.scene.add_entity(gs.morphs.Drone(file="/app/drones_urdf/drones/cf2x.urdf"))
    ...
    def step(self, actions):
        ...
        # 14468 is hover rpm
        self.drone.set_propellels_rpm((1 + exec_actions * 0.8) * 14468.429183500699) # 14468.429183500699
        self.scene.step()
